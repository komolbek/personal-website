      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            <div className="text-center p-6 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 card-hover">
              <StatCounter end={companyStats.years} suffix="+" className="text-3xl font-bold gradient-text mb-1" />
              <div className="text-sm text-gray-500 dark:text-gray-400">{t.about.stats.years}</div>
            </div>
            <div className="text-center p-6 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 card-hover">
              <StatCounter end={companyStats.projects} suffix="+" className="text-3xl font-bold gradient-text mb-1" />
              <div className="text-sm text-gray-500 dark:text-gray-400">{t.about.stats.projects}</div>
            </div>
            <div className="text-center p-6 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 card-hover">
              <StatCounter end={companyStats.clients} suffix="+" className="text-3xl font-bold gradient-text mb-1" />
              <div className="text-sm text-gray-500 dark:text-gray-400">{t.about.stats.clients}</div>
            </div>
            <div className="text-center p-6 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 card-hover">
              <StatCounter end={20} suffix="+" className="text-3xl font-bold gradient-text mb-1" />
              <div className="text-sm text-gray-500 dark:text-gray-400">{t.about.stats.technologies}</div>
            </div>
          </div>
