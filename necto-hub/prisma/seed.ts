...
async function main() {
  ...
  const projectTypesData = [
    ...
    },
    {
      ...
      basePrice: 1200,
      baseDescription: 'System design + 1 integration service + deployment',
      sortOrder: 4,
      features: [
        { name: 'CCTV / camera configuration', price: 300, supportsQuantity: true, unitLabel: 'camera', sortOrder: 0 },
        { name: 'People counting setup', price: 400, supportsQuantity: false, unitLabel: null, sortOrder: 1 },
        { name: 'Sensor integration (temperature, humidity, etc.)', price: 250, supportsQuantity: true, unitLabel: 'sensor type', sortOrder: 2 },
        { name: 'Data collection service (API poller / MQTT)', price: 500, supportsQuantity: false, unitLabel: null, sortOrder: 3 },
        { name: 'Dashboard & analytics', price: 600, supportsQuantity: false, unitLabel: null, sortOrder: 4 },
        { name: 'Alerts & notifications (Telegram / email)', price: 200, supportsQuantity: false, unitLabel: null, sortOrder: 5 },
        { name: 'NVR / gateway configuration', price: 300, supportsQuantity: true, unitLabel: 'device', sortOrder: 6 },
        { name: 'Third-party system integration', price: 400, supportsQuantity: true, unitLabel: 'system', sortOrder: 7 },
        { name: 'On-site installation support', price: 300, supportsQuantity: true, unitLabel: 'day', sortOrder: 8 },
        { name: 'Hardware procurement assistance', price: 150, supportsQuantity: false, unitLabel: null, sortOrder: 9 },
      ],
    },
    {
      name: 'Production Management System',
      basePrice: 3000,
      baseDescription: 'Core production module + auth + basic UI + deployed',
      sortOrder: 5,
      features: [
        { name: 'Inventory management', price: 800, supportsQuantity: false, unitLabel: null, sortOrder: 0 },
        { name: 'Batch / lot tracking', price: 600, supportsQuantity: false, unitLabel: null, sortOrder: 1 },
        { name: 'Production scheduling & planning', price: 700, supportsQuantity: false, unitLabel: null, sortOrder: 2 },
        { name: 'Warehouse / zone management', price: 500, supportsQuantity: false, unitLabel: null, sortOrder: 3 },
        { name: 'Quality control & inspection', price: 500, supportsQuantity: false, unitLabel: null, sortOrder: 4 },
        { name: 'Supplier management', price: 400, supportsQuantity: false, unitLabel: null, sortOrder: 5 },
        { name: 'Barcode / QR code integration', price: 300, supportsQuantity: false, unitLabel: null, sortOrder: 6 },
        { name: 'Reports & analytics dashboard', price: 500, supportsQuantity: false, unitLabel: null, sortOrder: 7 },
        { name: 'Multi-user roles & permissions', price: 300, supportsQuantity: false, unitLabel: null, sortOrder: 8 },
        { name: 'Mobile companion app', price: 1500, supportsQuantity: false, unitLabel: null, sortOrder: 9 },
        { name: 'API layer (external integrations)', price: 500, supportsQuantity: false, unitLabel: null, sortOrder: 10 },
        { name: 'Multi-language support', price: 200, supportsQuantity: true, unitLabel: 'language', sortOrder: 11 },
      ],
    },
  ];
