        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-paper backdrop-blur-sm rounded-2xl p-8 border border-line">
            ...
            <section className="mb-8">
              ...
              <p className="text-ink-muted mb-4">
                <strong className="text-ink">MemoMind stores most of your data locally on your device.</strong>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-ink-muted space-y-2">
                <li>
                  <strong className="text-ink">Apple Speech Recognition:</strong> For on-device
                  transcription of your voice recordings.
                </li>
                <li>
                  <strong className="text-ink">Groq AI:</strong> For processing transcripts
                  and generating summaries. Data is not retained after processing.
                </li>
                <li>
                  <strong className="text-ink">Apple StoreKit:</strong> For processing in-app
