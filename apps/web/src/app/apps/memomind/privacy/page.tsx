        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                <strong className="text-gray-900">MemoMind stores most of your data locally on your device.</strong>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>
                  <strong className="text-gray-900">Apple Speech Recognition:</strong> For on-device
                  transcription of your voice recordings.
                </li>
                <li>
                  <strong className="text-gray-900">Groq AI:</strong> For processing transcripts
                  and generating summaries. Data is not retained after processing.
                </li>
                <li>
                  <strong className="text-gray-900">Apple StoreKit:</strong> For processing in-app
