    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <div className="text-center max-w-lg">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            href="/works"
            className="inline-flex items-center gap-2 px-6 py-3 border border-line-strong hover:border-indigo-300 text-ink-muted hover:text-indigo-600 font-medium rounded-full transition-all duration-300"
          >
            {t.portfolio}
          </Link>
          <Link
